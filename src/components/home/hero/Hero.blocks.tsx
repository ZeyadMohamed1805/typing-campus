...
import { useHeroAnimatedTypingText, useHeroAuthNavigation } from "./useHero.hooks";
...
export const HeroCtaButtons = () => {
    ...
    return (
        <div className={styles.ctaButtons}>
            ...
            <button className={styles.secondary} onClick={heroCtaButtonsData.handleAuthNavigation}>Join Now</button>
        </div>
    );
}